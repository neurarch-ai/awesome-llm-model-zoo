...
![GLM-4.5-Air architecture](assets/diagram.svg)
...
The diagram and `model.json` show the full forward path with one of the 46 decoder blocks expanded (the stack repeats x46). All hyperparameters are taken from the official `config.json` on Hugging Face.
